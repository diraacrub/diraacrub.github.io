    ...
    <div class="slide-container">
            ...
            <ul class="slide-content">
                ...
                <li><strong>Funciones Clave Asignadas:</strong>
                    <ul>
                        ...
                        <li>Control del presupuesto y planta docente.</li>
                        <li>Elaboración de resoluciones (altas, bajas, licencias).</li>
                        <li>Supervisión y asesoramiento sobre obligaciones docentes.</li>
                    </ul>
                </li>
            </ul>
        </div>
        ...
        <div class="slide hidden">
            ...
            <ul class="slide-content">
                ...
                <li><strong>Eficiencia Administrativa:</strong> El "anteproyecto resolutivo" evoluciona a "resolución definitiva", agilizando circuitos.</li>
            </ul>
        </div>
        ...
        <div class="slide hidden">
            ...
            <ul class="slide-content">
                 ...
                 <li>Estos sistemas son centrales en la operatoria diaria actual.</li>
            </ul>
        </div>
            ...
            <ul class="slide-content">
                ...
                <li><strong>Vínculos Internos (CRUB):</strong>
                    <ul>
                        ...
                        <li>(Menor escala) Dpto. de Alumnos</li>
                    </ul>
                </li>
                <li><strong>Vínculos (Adm. Central):</strong> Rectorado, Sec. Académica (Central) y Dir. Gral. de RRHH.</li>
                <li><strong>Soporte Técnico:</strong> Vía de comunicación directa con DTI (por Sistema Mocoví).</li>
            </ul>
        </div>
        ...
        <div class="slide hidden">
            ...
            <ul class="slide-content">
                ...
                <li><strong>Requisito:</strong> Es indispensable manejar el lenguaje específico institucional.</li>
            </ul>
        </div>
        ...
        <div class="slide hidden">
            ...
            <ul class="slide-content">
                ...
                <li><strong>Impacto:</strong> Paulatina "despapelización" y fomento de la autonomía del usuario.</li>
            </ul>
        </div>
        ...
        <div class="slide hidden">
            ...
            <ul class="slide-content">
                ...
                <li><strong>Datos CRUB:</strong> Base docente de […..] y […..] cargos.</li>
                <li><strong>Apoyo Local:</strong> Articulación frecuente con Bedelía e Informática.</li>
            </ul>
        </div>
        ...
        <div class="slide hidden">
            ...
            <ul class="slide-content slide-content-darker">
                ...
                <li>Estrategia para articular con el personal.</li>
                <li>Aptitud y conocimientos de sistemas (Mocoví).</li>
                <li>Estilo prolijo y minucioso (control del crédito docente).</li>
